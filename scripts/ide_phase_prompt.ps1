...
switch ($Phase) {
  ...
  "design-big" {
    ...
    Write-Host "- revision/_workspace/02_domain-researcher_design-big.md"
    Write-Host "- revision/_workspace/02_domain-researcher_design-big.json"
    Write-Host "- revision/_workspace/07_research-citation-auditor_design-big.md"
    Write-Host "- revision/_workspace/07_research-citation-auditor_design-big.json"
  ...
  "design-small" {
    ...
    Write-Host "- revision/_workspace/02_domain-researcher_design-small.md"
    Write-Host "- revision/_workspace/02_domain-researcher_design-small.json"
  }
  "create" {
    Write-Host "Goal: draft chapters from design/state files."
    Write-Host "Required outputs:"
    Write-Host "- revision/_workspace/00_chief-editor-orchestrator_create.md"
    Write-Host "- revision/_workspace/00_chief-editor-orchestrator_create.json"
  ...
  "polish" {
    ...
    Write-Host "Required outputs:"
    Write-Host "- revision/_workspace/00_chief-editor-orchestrator_polish.md"
    Write-Host "- revision/_workspace/00_chief-editor-orchestrator_polish.json"
  ...
  "rewrite" {
    ...
    Write-Host "Required outputs:"
    Write-Host "- revision/_workspace/00_chief-editor-orchestrator_rewrite.md"
    Write-Host "- revision/_workspace/00_chief-editor-orchestrator_rewrite.json"
  ...
  "export" {
    ...
    Write-Host "Required outputs:"
    Write-Host "- revision/_workspace/00_chief-editor-orchestrator_export.md"
    Write-Host "- revision/_workspace/00_chief-editor-orchestrator_export.json"
    Write-Host "- revision/_workspace/07_research-citation-auditor_export.md"
    Write-Host "- revision/_workspace/07_research-citation-auditor_export.json"
